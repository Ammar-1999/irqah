...
function Accordion({
  ...
  const [expandedItem, setInternalExpanded] = useState<React.Key | null>(
  ...
  return (
    <MotionConfig transition={transition}>
      <AccordionContext.Provider
        value={{ expandedItem, setExpandedItem, variants }}
      >
  ...
  return (
    <div
      className={cn(
        "overflow-hidden",
        className,
        isExpanded && classNameOnOpen,
        !isExpanded && classNameOnClose
      )}
...
function AccordionTrigger({
  ...
  return (
    <button
      ...
      className={cn("group w-full", className, isExpanded && openClassName)}
      disabled={isExpanded}
    >
      {children}
    </button>
